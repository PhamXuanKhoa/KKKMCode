...
const treeVariants = cva(
    'relative group hover:before:opacity-100 before:absolute before:rounded-lg before:inset-x-0 before:inset-y-0.5 before:opacity-0 before:bg-accent/50 before:-z-10 text-foreground transition-colors before:content-[""]'
)

const selectedTreeVariants = cva(
    'before:opacity-100 before:bg-white/10 text-primary font-medium'
)
    ...
    (
        ...
        return (
            <div
                ...
                {...props}
            >
                {/* Spacer to match the chevron size in TreeNode */}
...
const TreeIcon = ({
    ...
    return Icon ? (
        <Icon className="h-4 w-4 shrink-0 mr-2 text-muted-foreground/80" />
    ) : (
        <></>
    )
}
